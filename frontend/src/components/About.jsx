import about from '../assets/prathamab.png'

const About = ({darkMode}) => {
  return (
    <section
      id="about"
      className={`min-h-screen overflow-hidden flex items-center justify-center px-4 sm:px-4 sm:px-6`}
    >
      <div className="max-w-6xl w-full grid grid-cols-1 gap-8 sm:gap-12 items-center lg:[grid-template-columns:1.0fr_1.4fr]">
        <figure
          data-aos="fade-up"
          data-aos-delay="300"
        ...
        >
          ...
          <p
            ...
            data-aos-delay="500"
          >
            I am a Computer and Communication Engineering student with interests
            in VLSI design, FPGA systems, communication, and signal processing.
            I enjoy working at the intersection of hardware and algorithms to
            build efficient and optimized systems.
            <br />
            <br />
            I have also explored full-stack development, gaining a foundational
            understanding of modern web technologies and system design.
            <br />
            <br />
            With a strong focus on problem-solving, discipline, and continuous
            learning, I am always eager to take on new challenges and contribute
            to impactful, real-world solutions.
          </p>
