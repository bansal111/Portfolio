...
const skillsData = {
  All:[
    ...
    { name: 'Html', icon: html, level: 88, color: 'from-yellow-500 to-amber-500' },
    { name: 'CSS', icon: css, level: 70, color: 'from-teal-500 to-cyan-500' },
    ...
    { name: 'SQL', icon: sql, level: 70, color: 'from-green-500 to-emerald-500' },
